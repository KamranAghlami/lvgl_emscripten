...
namespace ui
{
    namespace lvgl
    {
        ...
        public:
            ...
            style &set_bg_color(color v);
            style &set_bg_opa(uint8_t v);
            style &set_bg_grad_color(color v);
            ...
            style &set_outline_color(color v);
            ...
            style &set_shadow_color(color v);
            style &set_shadow_opa(uint8_t v);
            style &set_image_opa(uint8_t v);
            style &set_image_recolor(color v);
